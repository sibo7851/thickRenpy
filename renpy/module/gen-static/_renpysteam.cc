...
static struct _inittab _renpysteam_inittab[] = {
#if PY_MAJOR_VERSION < 3
    { "_renpysteam", init_renpysteam },
#else
    { "_renpysteam", PyInit__renpysteam },
#endif
    { NULL, NULL },
};

static void _renpysteam_constructor(void) __attribute__((constructor));

static void _renpysteam_constructor(void) {
    PyImport_ExtendInittab(_renpysteam_inittab);
}
