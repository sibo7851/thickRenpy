...
static const char __pyx_k_home_muffchad_renpyMacBuild_ren[] = "/home/muffchad/renpyMacBuild/renpy-build/renpy/renpy/gl/glrtt_fbo.pyx";
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initrenpy_gl_glrtt_fbo(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initrenpy_gl_glrtt_fbo(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_renpy_gl_glrtt_fbo(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_renpy_gl_glrtt_fbo(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("renpy.gl.glrtt_fbo", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
...
static struct _inittab renpy_gl_glrtt_fbo_inittab[] = {
#if PY_MAJOR_VERSION < 3
...
static void renpy_gl_glrtt_fbo_constructor(void) __attribute__((constructor));

static void renpy_gl_glrtt_fbo_constructor(void) {
    PyImport_ExtendInittab(renpy_gl_glrtt_fbo_inittab);
}
