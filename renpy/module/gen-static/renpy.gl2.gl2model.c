...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initrenpy_gl2_gl2model(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initrenpy_gl2_gl2model(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_renpy_gl2_gl2model(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_renpy_gl2_gl2model(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("renpy.gl2.gl2model", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
...
static struct _inittab renpy_gl2_gl2model_inittab[] = {
#if PY_MAJOR_VERSION < 3
...
static void renpy_gl2_gl2model_constructor(void) __attribute__((constructor));

static void renpy_gl2_gl2model_constructor(void) {
    PyImport_ExtendInittab(renpy_gl2_gl2model_inittab);
}
